...
class AppTypography {
  static final TextStyle displayLarge = GoogleFonts.lexend(
    fontSize: 57,
    fontWeight: FontWeight.w700,
  );
  static final TextStyle displayMedium = GoogleFonts.lexend(
    fontSize: 45,
    fontWeight: FontWeight.w700,
  );
  static final TextStyle displaySmall = GoogleFonts.lexend(
    fontSize: 36,
    fontWeight: FontWeight.w700,
  );
